...
public class PaymentDrawingActivity extends AppCompatActivity {
    ...
    private TextView txtPriceDrawing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_drawing);
        initView();
        ...
        editor.putString("payFor", "طراحی عکس سیاه قلم").apply();
        ...
        editor.putLong("pDrawing", getIntent().getLongExtra("pDrawing", 0)).apply();
        editor.putLong("pPrint", getIntent().getLongExtra("pPrint", 0)).apply();
        editor.putLong("pPost", getIntent().getLongExtra("pPost", 0)).apply();
        editor.putLong("pAll", preferences.getLong("pDrawing", 0) +
                preferences.getLong("pPrint", 0) +
                preferences.getLong("pPost", 0)).apply();
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PaymentDrawingActivity.super.onBackPressed();
            }
        });
    ...
    private void initView() {
        ...
        txtPriceDrawing = findViewById(R.id.txt_price_drawing);
    ...
    private void checkConnection() {
        ...
        if (!isConnected) {
            ...
            //Set Data
            txtPriceDrawing.setText(String.valueOf(preferences.getLong("pDrawing", 0)));
    ...
    private void payment(Long price) {
        ...
        if (price == 0) {
            ...
            paymentRequest.setDescription("پرداخت برای سفارش طراحی سیاه قلم");
    ...
    private boolean saveOrder() {
        ...
        try {
            ...
            postalCodeObj.put("postal_code", preferences.getString("postalCode", null));
        ...
        apiService.saveOrderDrawing(data.toString()).enqueue(new Callback<DesignerLogin>() {
            @Override
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        if (result) {
                            ...
                            editor.putInt("orderId", response.body().getId()).apply();
